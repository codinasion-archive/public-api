...
If you want to add or modify content, [search if an issue already exists](https://github.com/codinasion/public-api/issues). If a related issue doesn't exist, you can open a new issue using a relevant [issue template](https://github.com/codinasion/public-api/issues/new/choose).
...
```
git clone https://github.com/your_username/public-api
```
...
Add new sample Json data file in `data` folder.

#### Modify Content

Modify sample Json data file in `data` folder.

#### Add/update API

Add/update API in `pages/api` folder.
